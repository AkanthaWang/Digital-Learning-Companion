...
def test_full_pipeline():
    ...
    try:
        ...
        if result['success']:
            ...
            print(f"  LLM回复: {result['llm_response'][:100]}..." if len(
                result['llm_response']) > 100 else f"  LLM回复: {result['llm_response']}")
